...
## Reporting bugs
If you want to report a bug, head on over to our [bug report template](https://github.com/coltonsr77/WebTV-HD-Updated/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=%5BBug%5D+) and fill in the blanks. Make sure to provide screenshots and a video, if necessary.
